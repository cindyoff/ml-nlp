"""
Jointure : embeddings.parquet + features.parquet sur la clé PRIMARY_KEY pour produire un seul final.parquet avec toutes les colonnes.
"""
...
def merge(embeddings_path: str, features_path: str, output_path: str) -> None:
    ...
    if missing_in_emb:
        print(f"{len(missing_in_emb)} clés présentes dans features mais absentes dans embeddings")
