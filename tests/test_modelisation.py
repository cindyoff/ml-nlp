...
class TestComputeIV:
    def test_strong_separation(self):
        """IV élevé quand la feature discrimine bien les classes"""
        np.random.seed(42)
        n = 500
        # overlap pour que tous les bins aient 2 classes au lieu d'une
...
class TestSelectByIV:
    ...
    def test_filters_correctly(self):
        """feature forte est retenue et feature faible est écartée"""
        df = self._make_df()
